...
| DEC-018 | 2026-07-24 | Public/member splash screens follow the Nocturne specimen; Jenny uses a separate, operational Argent admin | Keeps the public experience focused on trust and discretion while protecting owner workflows from public navigation and consumer-style design | Product research, access-policy work, or final brand approval changes the role boundary |
