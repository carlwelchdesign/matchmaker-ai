...
| DEC-017 | 2026-07-24 | Build a local-only synthetic concept prototype before external research, without enabling real intake or production workflows | Gives the owner a concrete product artifact to review while preserving research, privacy, lifecycle, and launch gates | Prototype introduces persistence, external access, real people/data, claims, or a production decision |
| DEC-018 | 2026-07-24 | Public/member splash screens follow the Nocturne specimen; Jenny uses a separate, independently deployed Argent admin application | Keeps the public experience focused on trust and discretion while giving owner workflows an independent deployment and future access-control boundary | Product research, access-policy work, or final brand approval changes the role boundary |
| DEC-019 | 2026-07-24 | Treat external matchmaking networks, registries, CRMs, and partner data sources as future, opt-in B2B integrations—not a public people-data API or an initial product dependency | Current research found private networks and proprietary tools, not a reliable public API for confidential dating profiles. This preserves consent, contractual control, and a manual fallback while Argent validates its own service. | A named provider supplies documentation and approved terms, privacy/security review passes, and a dedicated integration ADR and ticket are approved. |
| DEC-020 | 2026-08-24 | Develop candidate interviewing as an applicant-controlled, text-first adaptive experience behind `candidate-interviewing`; keep first-pilot candidate submission free and prohibit hidden compatibility or candidate-value scoring | Mode choice, editable sources, field approval, human review, and controlled rollout create differentiation without making AI consequential; current estimated marginal AI cost does not justify pay-to-be-considered risk | Research rejects the experience, safety/accessibility gates cannot pass, measured unit economics differ materially, or founder/legal/product explicitly supersede DEC-016 |
